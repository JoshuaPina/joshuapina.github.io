        ...
        const userData = {
            ...
            visualPortfolio: "https://joshuapina.github.io/pages/home.html", // Your standard portfolio page
...
1. [Fall 2025] Data Science Capstone
   A senior group project tasked with forecasting larceny-related risks across Atlanta’s 25 Neighborhood Planning Units.
   Tech: PyTorch, TensorFlow, Scikit-Learn, GeoPandas, W&B, Streamlit

2. [Fall 2025] The Living Library
   A resource-stacked database charged with assisted future Data Science students with learning the field. This project leverages sentence-transformers for semantic searching.
   Tech: Python, Hugging Face, PostgreSQL, FastAPI

3. [Summer 2025] ML study on HNSCC Tumors
   An interdisciplinary ML project aimed at studying labeled and unlabled cross-sectional axial ct scans in a mult-modal effort to improve RT treatment.
        ...
        function processCommand(input) {
            ...
            if (awaitingChoice) {
                ...
                if (choice === '1' || choice === 'terminal') {
                    ...
                    // existing GUI redirect code
                } else if (choice === 'help') {
                    awaitingChoice = false;  // Exit the choice state
                    commandsEnabled = true;   // Enable commands
...
function startMatrixRain() {
    ...
    let frameCount = 0;
    const maxFrames = 180; // ~2 seconds at 60fps
